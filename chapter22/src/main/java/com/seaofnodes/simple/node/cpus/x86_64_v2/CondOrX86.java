...
public class CondOrX86 extends MachConcreteNode implements MachNode{
    CondOrX86( Node or ) { super(or); }
    @Override public String op() { return "CondOr"; }
